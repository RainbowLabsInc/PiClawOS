...
# NOTE: _suppress_output() was removed – it redirected fd 1/2 to /dev/null
# which permanently broke systemd's StandardOutput=append redirect, killing
# all logging after local model load. The env vars above (LLAMA_CPP_LOG_LEVEL=0,
# GGML_LOG_LEVEL=0) + verbose=False in Llama() are sufficient.
